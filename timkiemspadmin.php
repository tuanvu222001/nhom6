...
if (isset($_POST['timkiem'])) {
    ...
    $query = "select * from sanpham where (TenSP like '%".$_tukhoa."%') OR (Gia like '%".$_tukhoa."%') OR (IDSP like '%".$_tukhoa."%')";
...
$sql = "select * from sanpham where (TenSP like '%".$_tukhoa."%') OR (Gia like '%".$_tukhoa."%') OR (IDSP like '%".$_tukhoa."%') LIMIT $start,$limit";
$thucthi = mysqli_query($conn,$sql);
    while ($dulieu = mysqli_fetch_array($thucthi)) {      
        echo'
                    <div class="home-product-item" href="chitietsanpham.php?IDSP='.$dulieu['IDSP'].'">
                        ...
                        <div class="home-product-item__button">
                            ...
                            <button class="home-product-item__delete"><a href="xoaspadmin.php?IDSP='.$dulieu['IDSP'].'">Xóa</a></button>
                        </div>                       
                    </div> ';
                }
            }

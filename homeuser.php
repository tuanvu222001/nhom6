                ...
                <nav class="pagination" aria-label="...">
                  <ul class="pagination pagination-lg">
                    <li class="page-item <?php echo ($cr_page <= 1)? 'disabled' : '' ?>">
                      <a class="page-link" href="homeuser.php?page=<?php echo $cr_page -1 ?>" >Previous</a>
                    </li>
                    <?php for($i=1; $i <=$page ; $i++) { ?>
                        <li class="page-item <?php echo ($cr_page == $i)? 'active' : '' ?>" aria-current="page">
                        <a class="page-link" href="homeuser.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                        </li>     
                    <?php } ?>
                    
                    <li class="page-item <?php echo ($cr_page >= $page)? 'disabled' : '' ?>">
                      <a class="page-link" href="homeuser.php?page=<?php echo $cr_page + 1 ?>">Next</a>
                    </li>
                  </ul>
                </nav>
            </div>

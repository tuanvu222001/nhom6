...
if(isset($_POST['dathang'])){
    ...
    if($tongtien>0){
        $query = mysqli_query($conn, "INSERT INTO hoadon(TongTien, IDKhachhang, Ten, DiaChi, Email, SoDienThoai, NgayDatHang, GhiChu)
        VALUES('$tongtien','$idkhachhang','$tenkh','$diachi', '$email', '$sdt', '$ngaydathang','$ghichu')");
       if($query){
           $mhd = mysqli_insert_id($conn);
           foreach($cart as $dulieu){
               mysqli_query($conn, "INSERT INTO chitiethoadon(MaHD, IDSP, Size, SoLuong) VALUES('$mhd','$dulieu[IDSP]', '$dulieu[Size]','$dulieu[SoLuong]')");
           }
           header('Location: hoadon.php');
       }
    }
    else{
        echo '<script>alert("Chưa có sản phẩm nào trong giỏ hàng để mua!")</script>';
    }
}
?>
            ...
            <div class="grid">
                <nav class="header__navbar">
                    ...
                    <ul class="header__navbar-list">
                        ...
                        <li class="header__navbar-item">
                            <a href="homeuser.php" class="header__navbar-item-link">
    ...
    <div class="container">
        <div class="size_container">
            ...
            <div class="sum-cart">
                ...
                <input type="hidden" name="tongtien"  value="<?php echo number_format($TongTien, 0, '.', '.') ?>">
            </div>  
            <form method="POST">
            ...
            <div class="group-body">
                <div class="row">
                    <div class="form-group col-4">
                        <input type="text" name="Ten" class="form-control" value="<?php echo ''.$Ten.''?>" placeholder="Họ tên *" required/>                  
                    </div>
                    <div class="form-group col-4">
                        <input type="text" name="Email" class="form-control" value="<?php echo ''.$Email.''?>" placeholder="Email *" required/>                     
                    </div>
                    <div class="form-group col-4">
                        <input type="text" name="SDT" class="form-control" value="<?php echo ''.$SDT.''?>" placeholder="Điện thoại *" required/>                   
                    </div>
                </div>
            </div>
            ...
            <div class="group-body">
                <div class="row">
                    <div class="form-group col-6">
                        <input type="text" name="DiaChi" class="form-control" value="" placeholder="Địa chỉ nhận hàng *" required/>                  
                    </div>
                    <div class="form-group col-6">
                        <input type="text" name="GhiChu" class="form-control" value="" placeholder="Ghi chú" />                     
                    </div>
                </div>
            </div>
            ...
            <!-- THANH TOÁN -->
            <div>
                <button name="dathang" class="summit-cart">Hoàn Tất Đặt Hàng</button>
            </div>
        </form>

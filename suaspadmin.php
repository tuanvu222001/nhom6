        ...
        <div class="size_container ">
            <div class="row">
                <div class="col-6 form-update-left">
                    <form action="suaspadmin.php" method="POST" class="form" id="" enctype="multipart/form-data">
                        <img src="https://www.sporter.vn/wp-content/uploads/2017/05/logo.png" alt="">
                        <h1 class="">SỬA SẢN PHẨM</h2>
                        <div class="form-group">
                            <label for="" class="form-label">Tên sản phẩm</label>
                            <input id="" value="<?php echo $dulieu['TenSP'] ?>" name="tensp" type="text" placeholder="VD: Bộ quần áo Arsenal sân nhà 2021 – 2022" class="form-control" required>
                            <input type="hidden" name="idsp" class="form__set-date" value="<?php echo $dulieu['IDSP'] ?>">
                        </div>

                        <div class="form-group">
                            <label for="" class="form-label">Giá</label>
                            <input class="form-control" name="gia" min="1" max="999999999" type="number" value="<?php echo $dulieu['Gia'] ?>" placeholder="" required="">
                        </div>

                        <div class="form-group">
                            <label for="" class="form-label">Mô tả</label>
                            <input id="" name="mota" type="text" placeholder="" class="form-control" value="<?php echo $dulieu['MoTa'] ?>" required>
                        </div>
                        ...
                        <button type="submit" name="suasp" class="form-submit">Cập Nhật</button>
<?php 
...
$sqli="UPDATE sanpham SET TenSP='$TenSP',Gia='$Gia',MoTa='$MoTa',Anh='$image' WHERE IDSP='$IDSP'";
if(mysqli_query($conn,$sqli)){
    ...
    echo '<script language="javascript">alert("Sửa không thành công!");</script>';
}
}
?>
                    </form>
                ...
                <div class="col-6">
                    <img src="./photo/<?php echo $dulieu['Anh'] ?>" alt="" class="form-update-right-img">
                </div>
